Use Fetch API and `Promises` to make asynchronous HTTP request to retrieve the channel info by using the twitchTV JSON API.  
  
Please see demo here: https://codepen.io/hieverest/full/VpoyZX/
